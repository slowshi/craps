...
export declare const passLineBetValidation: (currentBet: Partial<IBaseBet>, incomingBet: Partial<IBaseBet>, pointValue: number) => boolean;
export declare const passLinePointValidation: (currentBet: Partial<IBaseBet>, incomingBet: Partial<IBaseBet>, pointValue: number) => boolean;
export declare const dontPassLinePointValidation: (currentBet: Partial<IBaseBet>, incomingBet: Partial<IBaseBet>, pointValue: number) => boolean;
export declare const comeLineBetValidation: (currentBet: Partial<IBaseBet>, incomingBet: Partial<IBaseBet>, pointValue: number) => boolean;
export declare const comeLinePointValidation: (currentBet: Partial<IBaseBet>, incomingBet: Partial<IBaseBet>) => boolean;
export declare const dontComeLinePointValidation: (currentBet: Partial<IBaseBet>, incomingBet: Partial<IBaseBet>) => boolean;
export declare const centerBetValidation: (currentBet: Partial<IBaseBet>, incomingBet: Partial<IBaseBet>) => boolean;
export declare const numbersBetValidation: (currentBet: Partial<IBaseBet>, incomingBet: Partial<IBaseBet>) => boolean;
